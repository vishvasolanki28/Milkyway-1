...
public class retailerupdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailerupdate);
    ...
    public void onback(View view){
        startActivity(new Intent(retailerupdate.this,profile.class));
    }

    public void updateretailer(View view) {
        updateretailer();
    }
